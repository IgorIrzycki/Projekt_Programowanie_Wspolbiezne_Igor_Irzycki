...
public class WorkerComponent extends JPanel {
    ...
    public WorkerComponent(int x, int y, int indexCegly) {
        this.x = x;
        this.y = y;
        this.indexCegly = indexCegly;
        URL resource = null;
        try {
            resource = Path.of(System.getProperty("user.dir") + "/worker.png").toUri().toURL();
